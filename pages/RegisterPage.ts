...
export class RegisterPage{
    ...
    async verifyAccountCreation(username:string){
        ...
        if(headerText && rightPanelTExt){
            await expect(headerText.includes(`Welcome ${username}`)).toBeTruthy();
            await expect(rightPanelTExt.includes(`Your account was created successfully. You are now logged in.`)).toBeTruthy();
